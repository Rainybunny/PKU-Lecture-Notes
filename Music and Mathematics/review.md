...
- **十二律**、**五度相生**：
    ...
    - **旋宫不归**、**毕达哥拉斯音差**：第十一次相生得到第十二个音级为 $\sharp\t E$，在做一次理论上得到 $\sharp\t B$，但其频率实际是 $\br{\frac{3}{2}}^{12}\x\br{\frac{1}{2}}^7>1$（指数 $12$ 就是十二次相生，$7$ 是“反复折半直到回到初始音区，即数值落在 $[1,2)$ 之间”），这个差距就是毕达哥拉斯音差，也即“旋宫不归”的原因。
...
- **纯律**：
    ...
    - 令 $\t{C}-\t{E}-\t{G}$，$\t{F}-\t A-\t C'$，$\t G-\t B-\t D'$ 的频率比都是 $4:5:6$，这样就已经确定基本音级。（变化音级也是以“让和弦更纯”为原则规定的，省略。）
        $$
        \begin{array}{c|ccccc:ccccccc|c}
        &&\sharp\t C_4&&\sharp\t D_4&&&\sharp\t{F}_4&&\sharp\t{G}_4&&\sharp\t{A}_4\\
        \color{orange}{\t B_3}&\color{orange}{\t C_4}&&\t D_4&& \color{red}{\t E_4} & \color{red}{\t{F}_4}&&\t{G}_4&&\t{A}_4&&\color{cyan}{\t{B}_4}&\color{cyan}{\t{C}_5}\\
        \t{纯律}&1&&\frac{9}{8}&&\frac{5}{4}&\frac{4}{3}&&\frac{3}{2}&&\frac{5}{3}&&\frac{15}{8}&2\\
        \t{五度相生}&1&&\frac{8}{8}&&\frac{81}{64}&&&\frac{3}{2}&&\frac{27}{16}&&\frac{243}{128}&2
        \end{array}
        $$

    - **音差**：纯五度音程 $\t D-\t A$ 就变成 $80:54<81:54=\frac{3}{2}$，大二度也音程也产生 $9:8$ 和 $10:9$。

    - **协调音差**：$\t E$ 与五度相生的差距，$\frac{81}{80}$。
