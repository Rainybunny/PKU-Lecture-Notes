...
- 三分损益法
    - 旋宫不归
- 毕达哥拉斯: 五度相生 $\x\frac{3}{2}$, $\x\frac{3}{4}$, $\bmod 2$, 也有不归的问题, 称为 "毕达哥拉斯音差".
- 主调音乐
- 复调音乐: 各自相对独立
- 纯律: 加入 $\frac{5}{4}$ 的元素
- 平均律: 一个八度 $12$ 半音, 频率直接以 $r^{12}=2$ 的公比排列. (首次提出并计算: 明朝朱载㻙.)
- 音分: $f_1<f_2$ 的音分定义为 $1200\log_2\frac{f_2}{f_1}$, 对平均律的相邻两音, 结果为 $100$.