...
\newcommand{\map}[0]{\opn{map}}
\newcommand{\segs}[0]{\opn{segs}}
\newcommand{\tails}[0]{\opn{tails}}
\newcommand{\inits}[0]{\opn{inits}}
\newcommand{\append}[0]{\opn{+\!\!+}}
\newcommand{\scanl}[1]{\opn{\rightarrow\!\!\!\!\!\!/}{}{#1}}
\newcommand{\accuml}[1]{\opn{\rightarrow\!\!\!\!\!\!\!{/\!\!/}}{}{#1}}
$$

Below is the proof of BMF 1-3.
$$
\begin{array}{ccc}
	S &=& \oplus/\cdot f*\cdot{\color{red}\segs}\\
	&& \{\text{by definition}\}\\
	&=& \oplus/\cdot{\color{red}{f*\cdot\append/}}\cdot\tails*\cdot\inits\\
	&& \{\text{map promotion}\}\\
	&=& {\color{red}\oplus/\cdot\append/}\cdot (f*{\color{red}*})\cdot\tails{\color{red}*}\cdot\inits\\
	&& \{\text{reduce promotion, map distributivity}\}\\
	&=& \oplus/\cdot{\color{red}(\oplus/\cdot f*\cdot\tails)}*\cdot\inits\\
	&& \{T=\oplus/\cdot f*\cdot\tails=h\cdot\odot\scanl e\}\\
	&=& \oplus/\cdot h*\cdot{\color{red}\odot\scanl e*\cdot\inits}\\
	&& \{\text{by definition}\}\\
	&=& \oplus/\cdot h*\cdot\odot\accuml e
\end{array}
$$