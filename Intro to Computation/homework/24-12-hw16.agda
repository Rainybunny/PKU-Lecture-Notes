...
{-
Remark.
    It seems like "rewrite what you like with these rules" by default,
    which is indeed convenient for coding, but may lead to confusions.
-}