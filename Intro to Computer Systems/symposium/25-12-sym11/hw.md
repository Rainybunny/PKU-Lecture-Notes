...
|   题目   |        虚拟地址格式        |
| :------: | :------------------------: |
| **9.11** | $\t{00 0010 01 | 11 1100}$ |
| **9.12** | $\t{00 0011 10 | 11 1001}$ |
| **9.13** | $\t{00 0000 01 | 00 0000}$ |

&emsp;&emsp;(B)

|   参数    |    **9.11**     |    **9.12**     |    **9.13**     |
| :-------: | :-------------: | :-------------: | :-------------: |
|    VPN    | $\t{0000 1001}$ | $\t{0000 1110}$ | $\t{0000 0001}$ |
| TLB 索引  |    $\t{01}$     |    $\t{10}$     |    $\t{01}$     |
| TLB 标记  |  $\t{000010}$   |  $\t{000011}$   |  $\t{000000}$   |
| TLB 命中? |       否        |       否        |       否        |
|   缺页?   |       否        |       否        |       是        |
|    PPN    |    $\t{17}$     |    $\t{11}$     |        /        |
...
|   题目   |      物理地址格式       |
| :------: | :---------------------: |
| **9.11** | $\t{0101 11 | 11 1100}$ |
| **9.12** | $\t{0100 01 | 11 1001}$ |
