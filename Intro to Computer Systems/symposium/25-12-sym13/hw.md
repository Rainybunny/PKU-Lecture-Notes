...
&emsp;&emsp;(A) `exit(0)` 终止了子线程.

&nbsp;

**2.** (P724 12.18)

&emsp;&emsp;(A) 不安全: `L1` 进入不安全区.

&emsp;&emsp;(B) 安全.

&emsp;&emsp;(C) 不安全: `L2` 进入不安全区.
...
<img src="./fig1.jpg" style="zoom: 25%;" />

&nbsp;

**5.** (P725 12.30)

&emsp;&emsp;(A) 1: $(\t{a},\t{c}),(\t{a},\t{c})$. 2: $(\t{c},\t{b})$. 3: $(\t{a},\t{b})$.

&emsp;&emsp;(B) 线程 2 和线程 3.

&emsp;&emsp;(C) 规定 $c<b<a$, 线程 1 改为 `P(c); P(b); P(a); V(a); V(b); V(c);`
