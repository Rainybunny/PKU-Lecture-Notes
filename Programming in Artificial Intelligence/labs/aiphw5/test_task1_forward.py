...
def test_log_forward():
    ...
    a = [[1.0, 2.71828183, 7.3890561]]
    do_test(a)
    a = [[[1.0, 2.0], [7.0, 20.0]], [[0.5, 4.0], [10.0, 100.0]]]
    do_test(a)
    a = [[[1.0]], [[2.0]], [[3.0]]]
    do_test(a)
    a = [[1.0, 10.0, 100.0], [0.1, 0.01, 0.001]]
    do_test(a)
...
def test_exp_forward():
    ...
    a = [[0.0, 1.0, 2.0]]
    do_test(a)
    a = [[[0.0, 0.69314718], [1.94591015, 2.99573227]], [[-0.69314718, 1.38629436], [2.30258509, 4.60517019]]]
    do_test(a)
    a = [[[0.0]], [[0.69314718]], [[1.09861229]]]
    do_test(a)
    a = [[0.0, 2.30258509, 4.60517019], [-2.30258509, -4.60517019, -6.90775528]]
    do_test(a)
