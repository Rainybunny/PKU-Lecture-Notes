...
def build_argparser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="CIFAR10 LeNet (sequential, single-device)")
    ...
    p.add_argument("--logdir", type=str, default="./runs/seq")
    p.add_argument("--report", type=str, default="./reports/seq.json")
    p.add_argument("--save", type=str, default="./cifar_lenet_seq.pth")
